...
def line_plot():
    ...
    for team in teams:
        ...
        #print(df.head())
        y_axis_values = ['Average attendance', 'Arrivals M€', 'Squad market value M€', 'Infl adjusted squad market value M€',
                         'Average squad market value M€', 'Infl adjusted avg squad market value M€', 'Infl adjusted arrivals M€']
        ...
        for value in y_axis_values:
            ...
            # m, b = np.polyfit(years, value, 1)
            # line_x = np.arange(1, len(years))
            # line_y = m * line_x + b
